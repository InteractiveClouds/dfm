const
    ...
    RGX_IS_ARG_VALID = {
        ...
        install : /^(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/
    };
...
module.exports = function ( args ) {
    var raw = {
        ...
        if (command == 'install') raw.install = {}
    ...
    var noRestart      = command === 'update'  && raw.update.hasOwnProperty('norestart'),
        ...
        clear = {
            ...
            install : raw.install ? raw.install : false
        };
